        ...
        options: {
          twigOptions: {
            namespaces: {
              ...
              wa_atoms: path.resolve(__dirname, '../', 'components/01-atoms'),
              wa_molecules: path.resolve(
                __dirname,
                '../',
                'components/02-molecules',
              ),
              wa_organisms: path.resolve(
                __dirname,
                '../',
                'components/03-organisms',
              ),
              wa_templates: path.resolve(
                __dirname,
                '../',
